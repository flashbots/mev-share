...
Hash of the list of bundle bodies defined by [bundle composition](#bundle-composition). If there is only one transaction in the list, 
the `blockHash` returns the hash of that transaction.